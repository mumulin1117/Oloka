...
class GSDDloadingComin: UIView {
    ...
    override init(frame: CGRect) {
        ...
        defaultGSDDeLabel.frame = CGRect(x: 12, y: defaultGSDIndicator.frame.maxY + 10, width: UIScreen.main.bounds.width - 24, height: 50)
        successGSDDeLabel.frame = CGRect(x: 12, y: defaultGSDIndicator.frame.maxY + 10, width: UIScreen.main.bounds.width - 24, height: 50)
